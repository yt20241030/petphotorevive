      ...
      {stage === "idle" || stage === "uploading" ? (
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            {stage === "uploading" ? (
              <>
                <span className="text-lg font-medium text-amber-800">Restoring your photo…</span>
                <span className="text-sm text-zinc-500">This usually takes under a minute.</span>
              </>
            ) : (
              <>
